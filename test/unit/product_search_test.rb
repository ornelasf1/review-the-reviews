...
class ProductSearchTest < ActiveSupport::TestCase
    ...
    test "product search category 'movies' query 'super mario bros'" do
        ...
        #   ew.com: !ruby/object:Product
        #     name:
        #     score:
        #     maxscore:
        #     source:
        #     initial_source: https://ew.com/movies/super-mario-bros-tops-box-office/
        #     www.pluggedin.com: !ruby/object:Product
        #     name:
        #     score:
        #     maxscore:
        #     source:
        #     initial_source: https://www.pluggedin.com/blog/movie-monday-4-17-23/
        #     collider.com: !ruby/object:Product
        #     name:
        #     score:
        #     maxscore:
        #     source:
        #     initial_source: https://collider.com/box-office-hit-movies-bad-reviews/
        #     www.ign.com: !ruby/object:Product
        #     name: The Super Mario Bros. Movie Review - IGN
        #     score: 8.0
        #     maxscore: 10
        #     source: https://www.ign.com/articles/the-super-mario-bros-movie-review
        #     initial_source: https://www.ign.com/articles/the-super-mario-bros-movie-review
        #     www.rottentomatoes.com: !ruby/object:Product
        #     name: The Super Mario Bros. Movie
        #     score: 58
        #     maxscore: 100
        #     source: https://www.rottentomatoes.com/m/the_super_mario_bros_movie
        #     initial_source: https://www.rottentomatoes.com/m/the_super_mario_bros_movie
        #     www.rogerebert.com: !ruby/object:Product
        #     name: The Super Mario Bros. Movie
        #     score: 1.5
        #     maxscore: 4
        #     source: https://www.rogerebert.com/reviews/the-super-mario-bros-movie-movie-review-2023
        #     initial_source: https://www.rogerebert.com/reviews/the-super-mario-bros-movie-movie-review-2023
        #     www.commonsensemedia.org: !ruby/object:Product
        #     name: The Super Mario Bros. Movie
        #     score: 3
        #     maxscore: 5
        #     source: https://www.commonsensemedia.org/movie-reviews/the-super-mario-bros-movie
        #     initial_source: https://www.commonsensemedia.org/movie-reviews/the-super-mario-bros-movie
        #     www.empireonline.com: !ruby/object:Product
        #     name: this movie
        #     score: 2.0
        #     maxscore: 5
        #     source: https://www.empireonline.com/movies/reviews/the-super-mario-bros-movie/
        #     initial_source: https://www.empireonline.com/movies/reviews/the-super-mario-bros-movie/
        #     www.imdb.com: !ruby/object:Product
        #     name: The Super Mario Bros. Movie
        #     score: 7.1
        #     maxscore: 10
        #     source: https://www.imdb.com/title/tt6718170/
        #     initial_source: https://www.imdb.com/title/tt6718170/
        #     letterboxd.com: !ruby/object:Product
        #     name:
        #     score:
        #     maxscore: 5
        #     source: https://letterboxd.com/film/super-mario-bros/reviews/
        #     initial_source: https://letterboxd.com/film/the-super-mario-bros-movie/
        #     www.metacritic.com: !ruby/object:Product
        #     name: The super mario bros. movie 2023
        #     score: 8.4
        #     maxscore: 10
        #     source: https://www.metacritic.com/movie/the-super-mario-bros-movie
        #     initial_source: https://www.metacritic.com/movie/the-super-mario-bros-movie
        #     www.gamesradar.com: !ruby/object:Product
        #     name:
        #     score:
        #     maxscore: 5
        #     source: https://www.gamesradar.com/the-last-of-us-highest-rated-video-game-adaptation/
        #     initial_source: https://www.gamesradar.com/new-super-mario-bros-movie-trailer-sees-mario-and-princess-peach-take-on-bowser/
