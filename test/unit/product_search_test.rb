...
class ProductSearchTest < ActiveSupport::TestCase
    ...
    def assert_products_match input_hostname_to_urls, input_category, expected_products
      ...
      actual_products_map = @object.get_products(input_hostname_to_urls, input_category)
    ...
    test "product search category 'movies' query 'super mario bros'" do
      ...
      actual_products_map = @object.get_products(hostname_to_urls, category)
      ...
      assert_products_match hostname_to_urls, category, expected_products
    end
end